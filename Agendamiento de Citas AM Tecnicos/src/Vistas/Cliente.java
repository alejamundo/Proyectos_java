...
public class Cliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingreso de nuevos clientes ");
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        if (txtNombre.getText().length() == 0) {
            ...
            try {
                ...
                tipo=jcbTipoDoc.getItemAt(jcbTipoDoc.getSelectedIndex());
                razon=txtRazonS.getText();
                ps.setInt(1, doc);
                ps.setString(2, tipo);
                ...
                if (resultado > 0) {//si hay datos
                    JOptionPane.showMessageDialog(null, "Cliente agregado a la BD");
                    this.setVisible(false);
                    CRUD cr= new CRUD();
                    cr.setVisible(true);//luego de guardar los primeros datos voy a interfaz ubicacion
                } else {
                    JOptionPane.showMessageDialog(null, "No se agrego el nuevo cliente");
